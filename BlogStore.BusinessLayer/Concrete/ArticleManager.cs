...
namespace BlogStore.BusinessLayer.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        {
            if (!string.IsNullOrWhiteSpace(entity.Title) && entity.Title.Length >= 3 && entity.Title.Length <= 200 && 
            ...
            {
                throw new ArgumentException("Makale başlığı 3-200 karakter arasında olmalıdır ve açıklama boş olamaz.");
            }
        }
        ...
        public Article TGetArticlesWithAppUser(int id)
        {
            return _articleDal.GetArticlesWithAppUser(id);
        }
    }
}
